...
"""
    ...
    wh_sub.add_argument("--deliver", default="log", help="Delivery target: log, telegram, discord, signal, etc.")
...
""",
    ...
    pairing_approve_parser.add_argument("platform", help="Platform name (telegram, discord, signal)")
    ...
    def cmd_sessions(args):
        ...
        if action == "list":
            ...
            for src in ["cli", "telegram", "discord", "signal"]:
